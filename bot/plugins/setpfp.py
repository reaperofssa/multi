    ...
    async def setpfp_handler(event):
        ...
        try:
            ...
            if not event.is_reply:
                await event.edit("❌ Reply to an image to set as profile picture.")
                return
            ...
            if not reply.photo:
                await event.edit("❌ Replied message must contain a photo.")
                return
            ...
            # Download the photo
            await event.edit("📥 Downloading photo...")
            await reply.download_media(file=temp_path)

            # Upload the profile photo
            await event.edit("📤 Uploading as profile picture...")
            ...
            await event.edit("✅ Profile picture updated successfully!")
